...
public class Address {
    ...
    public boolean equals(Object o) {
        ...
        if (o == this){
            ...
            result = (addressLine1.equals((address.getAddressLine1())) &&
    ...
    public String toString(){
        String result = String.format("Address{addressLine1='%s', addressLine2='%s', city='%s', state='%s', zipcode='%s'}", addressLine1, addressLine2, city, state, zipcode);
        return result;
    }
}
